 ...
 */
import { lookupGlossaryBatch } from './glossary.js'
import type { SkosIndex } from './skos-loader.js'
import { loadSkosIndex, resetSkosIndex } from './skos-loader.js'
import { jaroWinklerDistance } from './string-similarity.js'
import { buildVocabularyIndex } from './vocabulary-index.js'

// Re-export for public API backward compatibility
export { jaroWinklerDistance } from './string-similarity.js'
