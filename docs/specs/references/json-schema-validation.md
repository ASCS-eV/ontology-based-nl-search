<!--
  ...
  Title:     JSON Schema Validation: A Vocabulary for Structural Validation of JSON (2020-12)
  Source:    https://json-schema.org/draft/2020-12/json-schema-validation
  Publisher: JSON Schema Org (IETF Internet-Draft)
  License:   BSD-3-Clause / Academic Free License v3.0 (see source repo LICENSE) (https://github.com/json-schema-org/json-schema-spec/blob/main/LICENSE)
