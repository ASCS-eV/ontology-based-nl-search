...
| `[ODR-OWL]` | ASAM OpenDRIVE — generated OWL 2 | `.ontology/imports/opendrive/opendrive.owl.ttl` — ASAM's own generated ontology, vendored by OMB v0.4.0+, pinned the same way as `[OSC-XSD]` | The "existing maps" cross-file road-reference check (`packages/authoring-gate/src/opendrive-ontology.ts`) resolves `T_road` / `T_road.id` from this by `rdfs:label`, never hand-typed. |
